...
namespace App\Services\Slots\Services;

use App\Services\Slots\Enums\AggregatorEnum;
use App\Services\Slots\SlotsAggregators\MobuleSlotsAggregator;

class SlotsService
{
    public function getAggregatorGames(AggregatorEnum $aggregator)
    {
    ...
    private function resolveAggregatorService(AggregatorEnum $enum)
    {
        return match ($enum) {
            AggregatorEnum::MOBULE => app(MobuleSlotsAggregator::class),
        };
    }
}
